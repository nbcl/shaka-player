...
shaka.media.PresentationTimeline = class {
  ...
  getSafeSeekRangeStart(offset) {
    ...
    // https://github.com/google/shaka-player/issues/2831, in which we tried to
    // seek repeatedly to catch up to the seek range, and never actually
    // "arrived" within it.  The video's currentTime is not as accurate as the
    // JS number representing the earliest segment time for some content.
